...
## [2.0.0](https://github.com/jaetill/game-night-pwa/compare/v1.2.1...v2.0.0) (2026-09-16)


### ⚠ BREAKING CHANGES

* **guests:** gameNights.json entries no longer carry invited[], rsvps[] or declined[]; readers must use guests[] (or normalizeGuests()). Deploy GeneratePresignedPost, nudgeNonResponders, rsvpLink and createEvent after the Pages deploy.

### Features

* **guests:** unified guests[] list replaces invited/rsvps/declined (ADR-0021) ([#380](https://github.com/jaetill/game-night-pwa/issues/380)) ([7abf4cd](https://github.com/jaetill/game-night-pwa/commit/7abf4cd31a01b88dea1ea4bc22498b96036f34bc))
* host sees who can't make it ([#370](https://github.com/jaetill/game-night-pwa/issues/370)) ([849275e](https://github.com/jaetill/game-night-pwa/commit/849275e7a3a0425fdfaea172b9389fff92579c67))
...
* **profile:** configurable default start time for new game nights ([#379](https://github.com/jaetill/game-night-pwa/issues/379)) ([4137fd6](https://github.com/jaetill/game-night-pwa/commit/4137fd6992edaa187f8edf8a8779a4e9e7fc6d6e))
